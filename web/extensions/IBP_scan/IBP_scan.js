...
function ibp_controls_setup() {
   ...
   var data_html =
      '<div id="id-ibp-time-display" style="top:50px; background-color:black; position:relative;"></div>'+
	...
	var controls_html = w3_divs('id-tc-controls w3-text-white', '',
        w3_div('w3-medium w3-text-aqua', '<b><a href="http://www.ncdxf.org/beacon/index.html">International Beacon Project</a> (IBP) Scanner</b>'),
	...
	time_display_setup('id-ibp-time-display');
...
kiwi_check_js_version.push({ VERSION_MAJ:1, VERSION_MIN:143, file:'extensions/IBP_scan/IBP_scan.js' });
