...
function tdoa_submit_button_cb2(){var i,j;tdoa.ngood=0;tdoa.field.forEach(function(f,i){if(f.good&&!tdoa.rerun)f.use=true;if(f.good&&f.use)tdoa.ngood++;});if(tdoa.ngood<2){tdoa_submit_state(tdoa.ERROR,'at least 2 available hosts needed');tdoa.rerun=tdoa.last_was_rerun=0;return;}
...
var show_mkrs=[];var ms2,me2
if(idx==tdoa.TDOA_MAP_NO_HOSTS||idx==tdoa.TDOA_MAP_WITH_HOSTS||idx==tdoa.COMBINED_MAP){ms2=tdoa.SINGLE_MAPS;me2=tdoa.SINGLE_MAPS+npairs;}else{ms2=idx;me2=ms2+1;}
