...
/* web/extensions/TDoA/TDoA.min.js (web/extensions/TDoA/TDoA.js = Tue Mar 12 09:30:37 2024) */
...
function tdoa_waterfall_close(){kiwi_clearTimeout(tdoa.preview_timeo);if(tdoa.wf_ws!=null&&tdoa.wf_mkr!=null){var mkr=tdoa.wf_mkr;tdoa.wf_mkr=null;tdoa_wf_preview(mkr);}else{tdoa.wf_ws=tdoa.wf_mkr=null;kiwi.wf_preview_mode=false;var auto=(wf.aper==kiwi.APER_AUTO);wf.save_maxdb=maxdb=tdoa.maxdb_save;wf.save_mindb_un=mindb_un=tdoa.mindb_un_save;wf_aper_cb('wf.aper',tdoa.aper_save);if(!tdoa.wf_conn_bad){w3_clearInnerHTML('id-tdoa-submit-status');}
