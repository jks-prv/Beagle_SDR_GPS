...
/* web/extensions/TDoA/TDoA.min.js (web/extensions/TDoA/TDoA.js = Sun Feb  4 08:44:26 2024) */
...
if(tdoa.wf_up){waterfall_add_line(wf_canvas_actual_line+1);var c=wf_cur_canvas;var id='Back to this Kiwi';var x=(c.width-c.ctx.measureText(id).width)/2;waterfall_add_text(wf_canvas_actual_line,x,14,id,'Arial',13,'white',4);}}
tdoa.wf_up=false;}
function tdoa_wf_preview(mkr){var h=mkr.kiwi_mkr_2_ref_or_host;tdoa.wf_url=h.h+':'+h.p;tdoa.wf_id_snr=h.id_snr
w3_innerHTML('id-tdoa-submit-status','Waterfall preview: '+h.id_snr+' ('+tdoa.wf_url+')');tdoa.wf_ws=open_websocket('W/F',function(){tdoa.wf_ws.send("SET auth t=kiwi");tdoa.wf_ws.send("SERVER DE CLIENT openwebrx.js W/F");tdoa.wf_ws.send("SET ident_user=TDoA_preview");tdoa.wf_ws.send("SET send_dB=1");tdoa.wf_ws.send("SET zoom=10 cf="+freq_displayed_kHz_str_with_freq_offset);tdoa.wf_ws.send("SET maxdb=0 mindb=-100");tdoa.wf_ws.send("SET wf_speed=3");wf_aper_cb('wf.aper',0);setTimeout(wf_autoscale_cb,500);},null,null,tdoa_waterfall_add_queue,on_ws_error,tdoa_waterfall_close,{url:tdoa.wf_url,new_ts:true,qs:'',all_msg_cb:tdoa_all_msg_cb});tdoa.wf_conn_bad=false;tdoa.preview_timeo=setTimeout(function(){if(tdoa.wf_ws)tdoa.wf_ws.close();},10000);kiwi.wf_preview_mode=true;}
