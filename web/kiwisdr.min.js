...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sat Mar 30 16:25:34 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Tue Apr  2 14:42:38 2024) */
...
if(onclick!=null){var s2=w3_div('id-play-button-container class-overlay-container w3-valign w3-halign-center||'+onclick,w3_inline('id-play-button w3-flex-col/','<img src="gfx/openwebrx-play-button.png" width="150" height="150" /><br><br>',s1));w3_create_appendElement('id-kiwi-body','div',s2);if(input){var el=w3_el('id-ident-input3');w3_attribute(el,'maxlength',Math.max(cfg.ident_len,kiwi.ident_min));owrx.capture_input_field=true;w3_field_select(el,{mobile:1});}
el=w3_el('id-play-button');el.style.marginTop=px(w3_center_in_window(el));}}
