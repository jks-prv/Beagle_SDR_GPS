...
/* web/extensions/ext.min.js (web/extensions/ext.js = Tue Jan 30 08:34:35 2024) */
...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Mon Jan 29 09:22:23 2024) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sun Feb  4 08:47:22 2024) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Jan 21 14:10:00 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Tue Jan 30 08:28:34 2024) */
...
function waterfall_add_line(line){var c;if(!wf.lineCanvas){c=document.createElement('canvas');c.width=16;c.height=1;var ctx=c.getContext('2d');ctx.fillStyle="white";ctx.fillRect(0,0,8,1);ctx.fillStyle="black";ctx.fillRect(8,0,8,1);wf.lineCanvas=c;}
...
function waterfall_add_text(line,x,y,text,font,size,color,strokeWidth){var c=wf_cur_canvas;w3_fillText_shadow(c,text,x,line+y,font,size,color,strokeWidth);if(line+10>c.height){var c2=wf_canvases[1];if(c2)w3_fillText_shadow(c2,text,x,line-c.height+y,font,size,color,strokeWidth);}}
