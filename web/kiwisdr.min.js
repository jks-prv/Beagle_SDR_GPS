...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Tue Sep 17 07:44:00 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Tue Sep 17 11:22:31 2024) */
...
return drag_ranges;}
function demod_envelope_where_clicked(x,y,drag_ranges,key_modifiers){var pbh=Math.round(scale_canvas_h/2);in_range=function(x,g_range){return g_range.x1<=x&&g_range.x2>=x&&y<=pbh;};dr=demodulator.draggable_ranges;if(key_modifiers.shiftKey){if(drag_ranges.line_on_screen&&in_range(x,drag_ranges.line))return dr.bfo;if(drag_ranges.envelope_on_screen&&in_range(x,drag_ranges.whole_envelope))return dr.pbs;}
