...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Wed Jul 19 09:06:09 2023) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Mon Jul 17 10:08:23 2023) */
...
/* web/kiwi/monitor.min.js (web/kiwi/monitor.js = Mon Jul 17 12:01:51 2023) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sat Jul 15 18:06:11 2023) */
...
function freq_memory_init(){var fmem;if(isNonEmptyString(owrx.override_fmem)){fmem=owrx.override_fmem.split(',');var prec=(cfg.show_1Hz||url_1Hz)?3:2;fmem.forEach(function(s,i){if(isNumber(s))s=s.toString();var f=s.parseFloatWithUnits('kM',1e-3);if(isNumber(f))
...
/* web/openwebrx/audio.min.js (web/openwebrx/audio.js = Sat Jul 15 18:07:09 2023) */
