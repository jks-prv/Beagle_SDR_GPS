...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Fri May  3 14:41:45 2024) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Thu Apr 25 09:21:59 2024) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Apr 28 13:20:37 2024) */
...
/* web/kiwi/waterfall.min.js (web/kiwi/waterfall.js = Fri May  3 08:47:13 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Fri May  3 14:54:47 2024) */
...
function set_ceilfloordb(done){maxdb=wf.auto_maxdb+wf.auto_ceil.val;mindb=wf.auto_mindb+wf.auto_floor.val;console.log('$set_ceilfloordb amin/amax/ceil/floor='+wf.auto_mindb+'/'+wf.auto_maxdb+'/'+wf.auto_ceil.val+'/'+wf.auto_floor.val);var range=maxdb-mindb;if(cfg.spec_min_range){if(range<cfg.spec_min_range){var boost=cfg.spec_min_range-range;console.log('$set_ceilfloordb BOOST orange='+range+' min='+mindb+' max='+maxdb+'=>'+(maxdb+boost)+' min_range='+cfg.spec_min_range);maxdb+=boost;range=maxdb-mindb;}}
mindb_un=mindb+zoomCorrection();console_log_dbgUs('$set_ceilfloordb min/max/un='+mindb+'/'+maxdb+'/'+mindb_un+' range='+range);setmaxmindb(done,false);w3_call('waterfall_maxmin_cb');if(done){freqset_select();kiwi_storeWrite('last_ceil_dB',wf.auto_ceil.val.toFixed(0));kiwi_storeWrite('last_floor_dB',wf.auto_floor.val.toFixed(0));}}
