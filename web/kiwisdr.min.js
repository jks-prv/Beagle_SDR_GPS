...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Jun 11 07:51:24 2023) */
...
function toggle_or_set_spec(set,val,dir){var no_close_ext=false;if(isNumber(set)&&(set&toggle_e.SET)){spec.source=+val;no_close_ext=((set&toggle_e.NO_CLOSE_EXT)!=0);}else{if(isUndefined(dir)||dir==false||dir==1){spec.source=(spec.source+1)%spec.CHOICES;}else{spec.source--;if(spec.source<0)spec.source=spec.CHOICES-1;}}
