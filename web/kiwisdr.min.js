...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Fri Aug 25 14:58:22 2023) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Sep  3 08:30:42 2023) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Sep  3 12:44:03 2023) */
...
function rf_attn_cb(path,val,done,first){console.log('rf_attn_cb val='+val+' done='+done+' first='+first+' kiwi.rf_attn='+kiwi.rf_attn);if(kiwi.model==kiwi.KiwiSDR_1)return;var attn=parseFloat(val);var input_attn=w3_el('id-rf-attn');var field_attn=w3_el('id-field-rf-attn');kiwi.rf_attn=attn;input_attn.value=attn;field_attn.innerHTML=attn.toFixed(1)+' dB';field_attn.style.color="white";if(!done||first){console.log('SET rf_attn='+attn.toFixed(1));snd_send('SET rf_attn='+attn.toFixed(1));}else{writeCookie('last_rf_attn',val);freqset_select();}}
