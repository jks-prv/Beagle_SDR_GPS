...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Fri Nov 24 16:24:12 2023) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Fri Nov 24 15:21:34 2023) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Nov 26 08:51:05 2023) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Nov 26 10:24:26 2023) */
...
function freq_memory_menu_show(shortcut_key){if(w3_isVisible('id-freq-memory-menu')){kiwi.freq_memory_menu_shown=0;return;}
...
function freq_memory_menu_show_cb(el,val,trace,ev){var hold=(!kiwi.fmem_auto_save&&ev&&ev.type=='hold');var hold_done=(!kiwi.fmem_auto_save&&ev&&ev.type=='hold-done');w3_colors('id-freq-menu','w3-text-white','w3-text-css-lime',hold);if(hold){freq_memory_add(freq_displayed_kHz_str_with_freq_offset);return;}else
if(hold_done){return;}
