...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Wed Nov 22 10:52:39 2023) */
...
var prec=(cfg.show_1Hz||url_1Hz)?3:2;fmem.forEach(function(s,i){if(isNumber(s))s=s.toString();var f=s.parseFloatWithUnits('kM',1e-3);if(isNumber(f))
