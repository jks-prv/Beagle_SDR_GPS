...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Wed Jun  5 10:24:01 2024) */
...
function kiwi_wb_only(){var s='Sorry, this KiwiSDR is configured to use non-web wideband connections only. <br>'+'See the Kiwi forum for details about wideband mode. <br>'+'Please check <a href="http://rx.kiwisdr.com" target="_self">rx.kiwisdr.com</a> for more KiwiSDR receivers available world-wide.';kiwi_show_msg(s);}
...
/* web/kiwi/ant_switch.min.js (web/kiwi/ant_switch.js = Sat Jun  1 09:10:25 2024) */
...
ant_switch_users_notify_change();return true;case"antsw_backend_err":ant_sw.ver=param[1];var s='Backend script <x1>'+ant_sw.backend_s+'</x1> function AntSW_ShowBackend() sent bad configuration data!';w3_innerHTML('id-antsw-error',s);w3_hide2('id-antsw-backend-info',true);w3_hide2('id-antsw-error',false);w3_hide2('id-antsw-container',true);w3_select_set_if_includes('ant_sw.backend','disable');ext_set_cfg_param('ant_switch.enable',false,EXT_SAVE);ant_switch_users_notify_change();return true;case"antsw_ver":console.log('antsw_ver='+param[1]);ant_sw.ver=param[1];var s='Backend script v'+ant_sw.ver;if(ant_sw.ver=='0.0')s='';w3_innerHTML('id-antsw-ver',s);if(cfg.ant_switch.enable){w3_hide2('id-antsw-backend-info',false);w3_hide2('id-antsw-error',true);w3_hide2('id-antsw-container',false);}
