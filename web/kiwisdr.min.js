...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Tue Aug 22 21:05:09 2023) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Tue Aug 22 21:50:44 2023) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Mon Aug 21 12:03:14 2023) */
...
if(pl.length>1){rv.has_value=true;rv.num=parseFloat(pl[1]);rv.string=pl[1];rv.string_case=pu[1];}else{rv.num=0;rv.string='';}}
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Fri Aug 18 21:32:14 2023) */
...
snd_send("SERVER DE CLIENT openwebrx.js SND");snd_send("SET dbug_v="+debug_v);w3_do_when_cond(function(){return(isArg(rx_chan)&&owrx.cfg_loaded);},function(){if(rx_chan!=0)return;var attn_ampl=0;if(gen_attn!=0){var dB=gen_attn+cfg.waterfall_cal;var ampl_gain=Math.pow(10,-dB/20);attn_ampl=0x01ffff*ampl_gain;}
