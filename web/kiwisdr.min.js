...
/* web/extensions/ext.min.js (web/extensions/ext.js = Sun Jan 14 08:49:43 2024) */
...
/* web/kiwi/kiwi_ui.min.js (web/kiwi/kiwi_ui.js = Thu Jan 11 09:10:17 2024) */
...
function sd_backup_click_cb(id,idx){console.log('sd_backup_click_cb debian_maj='+kiwi.debian_maj);kiwi.backup_size=null;w3_innerHTML('id-sd-backup-msg','formatting micro-SD card');w3_color('id-sd-backup-msg','');w3_innerHTML('id-sd-progress-text','');w3_el('id-sd-progress').style.width='0%';kiwi.sd_progress=-1;kiwi.sd_interval=kiwi_setInterval(sd_backup_progress,1000);w3_innerHTML('id-sd-backup-icon',kiwi.sd_backup_icon);ext_send("SET microSD_write");}
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sat Jan 13 21:12:00 2024) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Jan 14 21:54:45 2024) */
...
return el;}
function w3_disable_multi(el_id,disable){w3_els(el_id,function(el,i){console.log('w3_disable_multi disable='+disable+' t/o(el)='+typeof(el)+' nodeName='+el.nodeName);console.log(el);w3_set_props(el,'w3-disabled',disable);if(isDefined(el.nodeName)&&(el.nodeName=='SELECT'||el.nodeName=='INPUT')){try{if(disable)
el.setAttribute('disabled','');else
el.removeAttribute('disabled');}catch(ex){console.log('w3_disable:Attribute');console.log(ex);}}});}
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Mon Jan 15 06:09:23 2024) */
...
w3_div('id-optbar-rf-container');if(kiwi.model==kiwi.KiwiSDR_1){kiwi.rf_attn_disabled=true;var el=w3_el('id-rf-attn');w3_disable_multi('id-rf-attn-disable',true);el.title='no RF attenuator available';}
