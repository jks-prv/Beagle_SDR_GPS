...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Thu May 30 09:51:24 2024) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Thu May 16 12:53:49 2024) */
...
return null;}
function w3_event_log(el,id,event_name){var el=w3_el(el);if(el==null)return;el.addEventListener(event_name,function(){console.log('w3_event_log '+id+': '+event_name);});}
function w3_event_listener(id,el){var el=w3_el(el);if(!el)return null;if(!w3int.eventListener[id]){w3_event_log(el,id,'mouseup');w3_event_log(el,id,'mousedown');w3_event_log(el,id,'click');w3_event_log(el,id,'change');w3_event_log(el,id,'submit');w3_event_log(el,id,'focus');w3_event_log(el,id,'blur');w3int.eventListener[id]=true;}}
...
/* web/kiwi/waterfall.min.js (web/kiwi/waterfall.js = Thu May 16 12:59:59 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Thu May 16 13:53:41 2024) */
...
w3_divs('w3-text-aqua',w3_col_percent('',w3_divs('/w3-margin-T-8',w3_input('w3-label-inline/id-dx-filter-ident w3-input-any-change w3-padding-small','Ident','dx.filter_ident',dx.filter_ident,'dx_filter_cb'),w3_input('w3-label-inline/id-dx-filter-notes w3-input-any-change w3-padding-small','Notes','dx.filter_notes',dx.filter_notes,'dx_filter_cb')),90),w3_inline('w3-halign-space-around w3-margin-T-8 w3-text-white/',w3_checkbox('w3-label-inline w3-label-not-bold','case sensitive','dx.filter_case',dx.filter_case,'dx_filter_opt_cb'),w3_inline('',w3_text('','pattern match:'),w3_checkbox('w3-margin-left w3-label-inline w3-label-not-bold','grep','dx.filter_grep',dx.filter_grep,'dx_filter_opt_cb'))));confirmation_show_content(s,450,140,dx_filter_panel_close);w3_field_select('id-dx-filter-ident',{mobile:1});}
