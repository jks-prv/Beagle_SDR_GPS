...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Fri Jun  9 12:02:45 2023) */
...
function kiwi_init_cfg(){kiwi_set_freq_offset(cfg.freq_offset);var page_title=cfg.index_html_params.PAGE_TITLE;if(page_title=='')page_title='KiwiSDR';var el=w3_el('id-page-title');if(el)el.innerHTML+=page_title;w3_innerHTML('id-rx-photo-title',cfg.index_html_params.RX_PHOTO_TITLE);w3_innerHTML('id-rx-photo-desc',cfg.index_html_params.RX_PHOTO_DESC);w3_innerHTML('id-rx-title',decodeURIComponent(cfg.index_html_params.RX_TITLE));w3_innerHTML('id-owner-info',decodeURIComponent(cfg.owner_info));}
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sat Jun 10 08:49:12 2023) */
...
var rx_photo_spacer_height=owrx.height_top_bar_parts;function init_rx_photo(){var el=w3_el('id-top-photo-img');el.src=cfg.index_html_params.RX_PHOTO_FILE;el.alt=el.title=cfg.index_html_params.RX_PHOTO_DESC;el.style.paddingLeft=cfg.index_html_params.RX_PHOTO_LEFT_MARGIN?'50px':0;owrx.RX_PHOTO_HEIGHT=+(cfg.index_html_params.RX_PHOTO_HEIGHT)+rx_photo_spacer_height;w3_el("id-top-photo-clip").style.maxHeight=px(owrx.RX_PHOTO_HEIGHT);if(dbgUs||kiwi_isMobile()){close_rx_photo();}else{window.setTimeout(function(){close_rx_photo()},3000);}}
var rx_photo_state=1;function open_rx_photo(){rx_photo_state=1;html("id-rx-photo-desc").style.opacity=1;html("id-rx-photo-title").style.opacity=1;animate_to(html("id-top-photo-clip"),"maxHeight","px",owrx.RX_PHOTO_HEIGHT,0.93,kiwi_isMobile()?1:1000,60,function(){resize_waterfall_container(true);});w3_hide('id-rx-details-arrow-down');w3_show_block('id-rx-details-arrow-up');}
...
function owrx_init_cfg(){w3_do_when_rendered('id-rx-gmap',function(){w3_link_set('id-rx-gmap','https://www.google.com/maps/place/'+cfg.index_html_params.RX_GMAP);});owrx.cfg_loaded=true;}
...
dx_database_cb('',dx.db);if(dx.step_superDARN)setTimeout(function(){dx.filter_ident='superDARN';dx_filter_cb();},1000);}
