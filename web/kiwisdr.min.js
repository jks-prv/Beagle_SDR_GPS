...
/* web/extensions/ext.min.js (web/extensions/ext.js = Sat Sep 23 08:22:16 2023) */
...
/* web/kiwi/kiwi_ui.min.js (web/kiwi/kiwi_ui.js = Wed Oct  4 17:00:13 2023) */
...
e=re_progress.exec(s);if(e&&e.length>=3){kiwi.backup_progress=+e[1];if(e[2]=='G')kiwi.backup_progress*=1024;}};}
function sd_backup_blur(){kiwi_output_msg_p.intercept=null;}
function sd_backup_click_cb(id,idx){kiwi.backup_size=null;w3_innerHTML('id-sd-backup-msg','formatting micro-SD card');w3_color('id-sd-backup-msg','');w3_innerHTML('id-sd-progress-text','');w3_el('id-sd-progress').style.width='0%';kiwi.sd_progress=-1;kiwi.sd_interval=kiwi_setInterval(sd_backup_progress,1000);w3_innerHTML('id-sd-backup-icon',kiwi.sd_backup_icon);ext_send("SET microSD_write");}
...
function sd_backup_write_done(err){var msg='backup complete';var e=null;switch(err){case 1:e='no SD card inserted?';break;case 15:e='SD card I/O error';break;case 30:e='SD card already mounted?';break;case 31:e='SD card format error';break;default:break;}
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sun Oct  1 12:46:53 2023) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Wed Oct  4 16:03:57 2023) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Sep 17 12:08:19 2023) */
...
function freqset_update_ui(from){freq_displayed_Hz=freq_car_to_dsp(freq_car_Hz);var f_kHz=freq_displayed_Hz/1000;freq_displayed_kHz_str=f_kHz.toFixed(freq_field_prec(f_kHz));if(!waterfall_setup_done)return;if(freqset_restore_ui()==null)return;waterfall_position(owrx.WF_POS_RECENTER_IF_OUTSIDE);writeCookie('last_freq',freq_displayed_kHz_str_with_freq_offset);freq_dsp_set_last=freq_displayed_kHz_str_with_freq_offset;freq_step_update_ui();freq_link_update();vfo_update();if(from!=owrx.FSET_NOP&&from!=owrx.FSET_SCALE_DRAG&&from!=owrx.FSET_SCALE_TOUCH_DRAG&&from!=owrx.FSET_PB_CHANGE){freq_memory_update(freq_displayed_kHz_str_with_freq_offset);}
