...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Tue Sep  6 15:29:58 2022) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Wed Sep  7 15:59:51 2022) */
...
this.doset=function(){var freq=(freq_car_Hz/1000).toFixed(3);var mode=this.server_mode;var locut=this.low_cut.toString();var hicut=this.high_cut.toString();var mparam=(mode=='sam')?(' param='+(owrx.chan_null|(owrx.SAM_opts<<owrx.SAM_opts_sft))):'';var s='SET mod='+mode+' low_cut='+locut+' high_cut='+hicut+' freq='+freq+mparam;snd_send(s);var changed=null;if(freq!=owrx.last_freq){changed=changed||{};changed.freq=1;owrx.last_freq=freq;}
