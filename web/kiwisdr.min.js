...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Aug 25 08:55:57 2024) */
...
kiwi_storeWrite('last_freq',freq_displayed_kHz_str_with_freq_offset);freq_dsp_set_last=freq_displayed_kHz_str_with_freq_offset;freq_step_update_ui();freq_link_update();vfo_update();if(kiwi.fmem_auto_save&&!owrx.no_fmem_update&&from!=owrx.FSET_NOP&&from!=owrx.FSET_SCALE_DRAG&&from!=owrx.FSET_SCALE_TOUCH_DRAG&&from!=owrx.FSET_PB_CHANGE){freq_memory_add(freq_displayed_kHz_str_with_freq_offset);}
