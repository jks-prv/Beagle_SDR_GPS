...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Fri Aug  9 08:49:20 2024) */
...
if(window.hasOwnProperty('matchMedia')){var mQ=matchMedia('(pointer:coarse)');if(mQ.media==='(pointer:coarse)'){kiwi_touch=!!mQ.matches;}}else{if(window.hasOwnProperty('orientation')){kiwi_touch=true;}else{kiwi_touch=false;}}
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Fri Aug  9 08:48:12 2024) */
