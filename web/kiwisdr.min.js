...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sat May  4 18:53:09 2024) */
...
function freqstep_cb(path,sel,first,ev){var shiftKey=ev?ev.shiftKey:false;var hold=(ev&&ev.type=='hold');var hold_done=(ev&&ev.type=='hold-done');if(hold){owrx.freqstep_interval=setInterval(function(){freqstep_cb(null,sel);},100);return;}
if(hold_done){kiwi_clearInterval(owrx.freqstep_interval);return;}
