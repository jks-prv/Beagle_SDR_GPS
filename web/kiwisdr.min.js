...
/* web/extensions/ext.min.js (web/extensions/ext.js = Wed Sep 11 09:10:09 2024) */
...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Wed Sep 11 09:04:39 2024) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sun Sep  8 08:30:41 2024) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Tue Sep 17 06:26:58 2024) */
...
function openwebrx_resize(from){from=(isString(from)&&from.startsWith('orient'))?from:'event';resize_wf_canvases();resize_waterfall_container(true);extint_environment_changed({resize:1,passband_screen_location:1});resize_scale(from);position_top_bar();owrx.resize_seq++;mdev_log_resize();}
...
if(this.dragged_range==dr.anything_else||is_adj_BFO){new_value=this.drag_origin.offset_frequency+freq_change;if(new_value>bandwidth/2||new_value<-bandwidth/2){return rv;}
...
check_band();}
function waterfall_tune(f_kHz){if(f_kHz==0){waterfall_position(FSET_SET_FREQ,owrx.WF_POS_AT_FREQ,+ext_get_freq_kHz());}else{waterfall_position(FSET_SET_FREQ,owrx.WF_POS_AT_FREQ,f_kHz);owrx.waterfall_tuned=1;}
