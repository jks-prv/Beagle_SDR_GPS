...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Fri Jun 14 09:37:26 2024) */
...
cpu_stats_cb(o,o.ct,o.ce,o.fc);xfer_stats_cb(o.ac,o.wc,o.fc,o.ah,o.as);extint.srate=o.sr;extint.wb_srate=Math.round(o.wsr / 1e3);w3_call('mode_wb_srate',extint.wb_srate);extint.nom_srate=o.nsr;gps_stats_cb(o.ga,o.gt,o.gg,o.gf,o.gc,o.go);if(o.gr){kiwi.WSPR_rgrid=decodeURIComponent(o.gr);kiwi.GPS_fixes=o.gf;}
...
function kiwi_open_or_reload_page(obj){var url=w3_opt(obj,'url',null);if(isNull(url)){var host_port=w3_opt(obj,'hp',kiwi_host_port());var pathname=w3_opt(obj,'path','','/');var query=w3_opt(obj,'qs','','/?');url=kiwi_SSL()+host_port+pathname+query;}
