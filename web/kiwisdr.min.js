...
/* web/kiwi/ant_switch.min.js (web/kiwi/ant_switch.js = Thu Apr 11 09:53:25 2024) */
...
function ant_switch_admin_msg(param){console.log('ant_switch_admin_msg '+param.join('='));switch(param[0]){case"antsw_backends":ant_sw.backends_s=decodeURIComponent(param[1]).split(' ');console.log('antsw_backends='+ant_sw.backends_s);w3_innerHTML('id-antsw-backends',w3_select('w3-width-auto w3-label-inline','Switch device:','select','ant_sw.backend',ant_sw.backend,ant_sw.backends_s,'ant_switch_backend_cb'));w3_innerHTML('id-antsw-ip-url',w3_input('/w3-label-inline w3-label-not-bold w3-nowrap/w3-padding-small||size=40','IP address or URL:','ant_sw.ip_or_url',ant_sw.ip_or_url,'ant_switch_set_ip_or_url_cb'));return true;case"antsw_backend":console.log('antsw_backend='+param[1]);ant_sw.backend_s=param[1];if(isNonEmptyString(ant_sw.backend_s))
