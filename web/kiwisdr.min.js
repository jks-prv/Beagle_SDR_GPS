...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Feb 11 12:29:46 2024) */
...
var bin_server=0;var zoom_server=0;function owrx_msg_cb(param,ws){switch(param[0]){case"wf_setup":wf_init();break;case"extint_list_json":extint_list_json(param[1]);if(override_ext){w3_do_when_cond(function(){console.log('### '+(waterfall_setup_done?'GO':'WAIT')+' extint_open('+override_ext+')');return waterfall_setup_done;},function(){extint_open(override_ext,3000);},null,200);}
