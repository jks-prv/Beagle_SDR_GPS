...
/*
   NB: coloris_init() must be called only after all HTML using it has been instantiated
   because of how it dynamically adds the surrounding div/button to the input element.
*/
...
function coloris_init()
{
   ...
   Coloris.setInstance('.coloris-instance1', {
      theme: 'polaroid'
   });

   Coloris.setInstance('.coloris-instance2', {
      theme: 'polaroid',
      themeMode: 'dark',
      formatToggle: false,
      closeButton: true,
