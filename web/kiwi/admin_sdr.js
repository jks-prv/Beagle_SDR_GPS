   ...
   var s3 =
      w3_inline('w3-margin-T-16 w3-halign-space-between/',
         ...
         w3_inline('/w3-margin-between-16 w3-valign',
            ...
            w3_input('w3-text-black/w3-label-inline/w3-padding-small w3-RIF|width:75px|title="finds nearest freq"',
               'Freq', 'dx.o.search_f', '', 'dx_search_freq_cb'),
            w3_input('w3-text-black/w3-label-inline/w3-padding-small w3-RIF w3-input-any-change|width:150px' +
