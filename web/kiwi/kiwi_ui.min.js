...
/* web/kiwi/kiwi_ui.min.js (web/kiwi/kiwi_ui.js = Tue Oct  3 17:04:13 2023) */
...
function sd_backup_click_cb(id,idx){kiwi.backup_size=null;w3_innerHTML('id-sd-backup-msg','formatting micro-SD card');w3_innerHTML('id-sd-progress-text','');w3_el('id-sd-progress').style.width='0%';kiwi.sd_progress=-1;kiwi.sd_interval=kiwi_setInterval(sd_backup_progress,1000);w3_innerHTML('id-sd-backup-icon',kiwi.sd_backup_icon);ext_send("SET microSD_write");}
...
kiwi_clearInterval(kiwi.sd_interval);w3_innerHTML('id-sd-backup-icon','');w3_innerHTML('id-sd-backup-msg',msg);w3_colors('id-sd-backup-msg','red','',!err);}
