...
function gps_interface()
{
	...
	gps.innerHTML =
		...
		'';
	gps.style.top = gps.style.left = '10px';
	...
	ws_gps = open_websocket("GPS", timestamp);
...
function mfg_seq_set()
{
	...
	if (next_serno >= 0 && next_serno <= 9999) {
		ws_gps.send("SET set_serno="+ next_serno);
	}
}
