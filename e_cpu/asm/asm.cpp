...
int main(int argc, char *argv[])
{
	...
	if (gen) {
		...
		fprintf(hfp, "%s", warn);
		fprintf(hfp, "#ifndef _KIWI_GEN_H_\n#define _KIWI_GEN_H_\n\n// from assembler DEF directives:\n\n");
		...
		if (vfp) {
		    fprintf(vfp, "\n\n// generated values:\n\n");
		    double rx1_stages = preval("RX1_STAGES");
		    fprintf(vfp, "parameter RX1_12K_GROWTH = %.0f;\n", ceil(rx1_stages * log2(preval("RX1_12K_DECIM"))));
		    //fprintf(vfp, "parameter XX1_12K_GROWTH = %.0f;\n", rx1_stages * ceil(log2(preval("RX1_12K_DECIM"))));
		    fprintf(vfp, "parameter RX1_20K_GROWTH = %.0f;\n", ceil(rx1_stages * log2(preval("RX1_20K_DECIM"))));
		    //fprintf(vfp, "parameter XX1_20K_GROWTH = %.0f;\n", rx1_stages * ceil(log2(preval("RX1_20K_DECIM"))));
		    double rx2_stages = preval("RX2_STAGES");
		    fprintf(vfp, "parameter RX2_12K_GROWTH = %.0f;\n", ceil(rx2_stages * log2(preval("RX2_12K_DECIM"))));
		    //fprintf(vfp, "parameter XX2_12K_GROWTH = %.0f;\n", rx2_stages * ceil(log2(preval("RX2_12K_DECIM"))));
		    fprintf(vfp, "parameter RX2_20K_GROWTH = %.0f;\n", ceil(rx2_stages * log2(preval("RX2_20K_DECIM"))));
		    //fprintf(vfp, "parameter XX2_20K_GROWTH = %.0f;\n", rx2_stages * ceil(log2(preval("RX2_20K_DECIM"))));
		}
	}
