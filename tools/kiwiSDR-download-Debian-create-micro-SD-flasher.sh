...
echo "--- now do 'upD' on laptop to place scripts in /root/Beagle_SDR_GPS/tools"
echo "--- run ./Beagle_SDR_GPS/tools/kiwiSDR-customize-Debian-distro-with-KiwiSDR-config.sh"
reboot
